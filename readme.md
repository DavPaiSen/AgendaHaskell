...
- Pacotes Haskell: `containers`, `time`
...
2. Instale as dependências necessárias:
   ```
   cabal update
   cabal install containers time
   ```

3. Navegue ate a pasta dos arquivos e compile o programa:
   ```
   ghc Main.hs
   ```

## Como Executar e Utilizar o Programa
